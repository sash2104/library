...
# :heavy_check_mark: test/example/example.test.cpp

<a href="../../../index.html">Back to top page</a>

* category: <a href="../../../index.html#6e960e7cc692a917cd5882e779b205ff">test/example</a>
* <a href="{{ site.github.repository_url }}/blob/master/test/example/example.test.cpp">View this file on GitHub</a>
    - Last commit date: 2019-12-20 23:46:07+09:00
...
{% raw %}
```cpp
#line 1 "test/example/example.test.cpp"
#define PROBLEM "https://onlinejudge.u-aizu.ac.jp/courses/lesson/1/ALDS1/4/ALDS1_4_B"
#include <algorithm>
#include <iostream>
#include <vector>
